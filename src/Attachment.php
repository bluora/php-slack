...
class Attachment
{
    ...
    public function addField($field)
    {
        ...
        throw new InvalidArgumentException('The attachment field must be an instance of Bluora\Slack\AttachmentField or a keyed array');
    }
    ...
    public function addAction($action)
    {
        ...
        throw new InvalidArgumentException('The attachment action must be an instance of Bluora\Slack\AttachmentAction or a keyed array');
    }
